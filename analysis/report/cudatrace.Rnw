...
#plot(max_speedup, x = max_speedup$resolution, y = max_speedup$render_speedup, color = factor(max_speedup$max_num_threads), size = 10)
...
max_real_speedup <- max(max_speedup$real_speedup)
max_render_speedup <- max(max_speedup$render_speedup)
...
library(xtable)
print(xtable(max_speedup_each_res(total_speed)))
@
    \end{center}
\end{table}
